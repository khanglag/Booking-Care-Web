function getUserInfo() {
    ...
    const desc = document.querySelector('.form_descOfUser')?.textContent || '';
    return {
        id,
        name,
        gender,
...
function fillUserInfo() {
    ...
    document.querySelector('.input_descOfUser').value = userInfo.desc;
}
...
btnSubmitInfoUser.addEventListener('click',()=>{
    ...
    const description = document.querySelector('.input_descOfUser').value;
